...
export const ENVIRONMENT_PATTERNS = [
  {
    ...
    description: 'This plugin uses CLAUDE_ENV_FILE to persist environment variables across hook invocations. This can set variables that affect Claude Code or leak to subprocess environments.',
